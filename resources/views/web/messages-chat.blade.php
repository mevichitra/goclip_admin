        ...
        <div class="col-4 left-message-bar">
            <ul class="nav nav-pills my-3 row" id="pills-tab" role="tablist">
                <li class="nav-item col-6 text-center">
                    <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Chats</a>
                </li>
                <li class="nav-item col-6 text-center">
                        ...
                        <nav>
                            ...
                            <nav class="m-header-right">
                                ...
                                <div class="dropdown dropleft" style="margin:auto">
                                    <a class="" data-toggle="dropdown" aria-expanded="false" aria-haspopup="false" href="#">
