...
@section('content')
<?php
$path = url(config('app.admin_url')) . '/candidates';
?>
...
<div class="col-lg-12">
    <div class="card customers-profile">
        ...
        <div class="contact-detail">
            ...
            <!-- <a href="javascript:void(0)" type="button" class="btn btn-primary button-green green-border" onclick='document.location.href="<?php echo $path . '/create/' ?>"'>New Category</a> -->
            <div>
                <div class="row">
                    <div class="col-lg-12 col-md-12">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.deleteSelSingle', function(e) {
            ...
            if (confirm('Are you sure you want to delete ?')) {
                ...
                var ids = favorite.join(",");
                $.post('<?php echo $path; ?>/delete', 'ids=' + ids, function(data) {
                    window.location = '<?php echo $path . '/' . $active; ?>';
                });
            }
        });
