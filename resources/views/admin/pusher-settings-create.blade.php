                ...
                <div class="col-md-12">
                    <div class="card customers-profile">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <nav>
                                        <div class="nav nav-tabs" id="myTab" role="tablist">
                                            <button class="nav-link <?php echo $type == 'P' ? 'active' : ''; ?>" id="pusher_tab"
                                                data-bs-toggle="tab" data-bs-target="#pusher_settings" type="button"
                                                role="tab" aria-controls="pusher_settings" aria-selected="true"
                                                data-type="P"> <i class="fa fa-bell"></i> Pusher</button>
                                        </div>
                                    </nav>
                            ...
                            <!-- <div class="row"> -->
                            <form role="form" action="{{ url(config('app.admin_url') . '/pusher-settings-update') }}"
                                method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="tab-content col-md-12" id="myTabContent">
                                        <div class="row tab-pane fade <?php echo $type == 'P' ? 'show active' : ''; ?>" id="pusher_settings"
                                            role="tabpanel" aria-labelledby="pusher_setting_tab">
                                            <div class="col-lg-12 col-md-12">
                                                <div class="panel-body" style="padding-bottom: 32px;">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12 col-md-12">
                                                            ...
                                                            <div class="form-group label-floating is-empty row"
                                                                style="padding: 0px;margin: 0px;">
                                                                <label class="control-label title col-md-3 nopad">Pusher App
                                                                    Id</label>
                                                                <?php
                                                                if (old('pusher_app_id') != '') {
                                                                    $pusher_app_id = old('pusher_app_id');
                                                                } elseif (isset($pusherSettings->pusher_app_id) && $pusherSettings->pusher_app_id != '') {
                                                        ...
                                                        <div class="col-lg-12 col-md-12" style="padding-bottom: 25px">
                                                            ...
                                                            <div class="form-group label-floating is-empty row"
                                                                ...
                                                                } elseif (isset($pusherSettings->pusher_app_key) && $pusherSettings->pusher_app_key != '') {
                                                        ...
                                                        <div class="col-lg-12 col-md-12" style="padding-bottom: 25px">
                                                            ...
                                                            <div class="form-group label-floating is-empty row"
                                                                ...
                                                                } elseif (isset($pusherSettings->pusher_app_secret) && $pusherSettings->pusher_app_secret != '') {
                                                        ...
                                                        <div class="col-lg-12 col-md-12" style="padding-bottom: 25px">
                                                            ...
                                                            <div class="form-group label-floating is-empty row"
                                                                ...
                                                                } elseif (isset($pusherSettings->pusher_app_cluster) && $pusherSettings->pusher_app_cluster != '') {
